...
def populate_class_labels():
    ...
    # for populating class labels using the yolo.txt file stored in the working directory
...
'''
    ...
    # Define the name and absolute path of the class file
    class_file_name = 'yolo.txt'
    class_file_abs_path = dest_dir + os.path.sep + class_file_name
